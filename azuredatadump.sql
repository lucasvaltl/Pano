...
-- Generation Time: Mar 15, 2017 at 07:01 AM
...
--
-- Database: `app_pano_database`
--
CREATE DATABASE IF NOT EXISTS `app_pano_database` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `app_pano_database`;
...
(12399, 12401, 12435, 12426, 12408, 12432),
(12400, 12429, 12424, 12430, 12412, 12408),
(12401, 12416, 12427, 12422, 12399, 12418),
(12402, 12414, 12417, 12406, 12403, 12426),
(12403, 12402, 12421, 12414, 12411, 12431),
...
--
ALTER TABLE `comments`
  MODIFY `CommentID` int(40) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11366;
--
...
--
ALTER TABLE `messages`
  MODIFY `MessageID` int(40) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
--
