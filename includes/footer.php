<footer>
  ...
  <div class="row">
    ...
    <div class="col-md-15  col-xs-15  lv-icons">
        <a href="<?=SITE_ROOT?>/circles.php">   <i class="fa fa-circle-thin fa-3x"></i></a>
    </div>
    <div class="col-md-15  col-xs-15  lv-icons">
        <a href="<?=SITE_ROOT?>/upload.php">   <i class="fa fa-camera fa-3x"></i></a>
    </div>
    <div class="col-md-15  col-xs-15 lv-icons">
        <a href="<?=SITE_ROOT?>/profile-info.php?id=<?php echo $_SESSION['UserName'];?>">   <i class="fa fa-user-o fa-3x"></i></a>
    </div>
    <div class="col-md-15  col-xs-15 lv-icons">
