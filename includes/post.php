...
public function __construct ( $userName, $commentUserPictureID, $commentContent ){
...
public function __construct ($postPictureID, $postUserPictureID, $userName, $numLikes, $numComments, $postDescription, $postLocation){
      ...
      <div class="container post-meta vertical-center">
        ...
        <div class="post-like-comment col-md-1 col-xs-1 " >
          <p class="lv-icons lv-top-padding">
            <a href="#"><i class="fa fa-star-o fa-2x "></i></a>
