...
echo '    <div class="row ">
    ...
    <div class="col col-md-6  col-xs-6 container">
        ...
        <p class="profile-info-location location">
            ...
            <input class="form-control collection-name-input" type="text" name="Location" placeholder="Location e.g. (London, England)"
            ng-style="{\'width\': (Location.length == 0 ? \'320\': ((Location.length*9))) + \'px\'}" ng-model="Location"/>
        </p>
        <p class="profile-info-description">
            <input class="descripton-text-box form-control collection-name-input" width="50%" type="text" name="ShortDescrip" value="' .$ShortDescrip . '" placeholder="Description (140 characters max)"
    ...
    <div class="col col-md-3 col-xs-3 profile-info-row">
            <button type="submit" class="btn btn-default pull-right save-button"><span class="glyphicon glyphicon-floppy-save"></span>&nbsp;&nbsp;Save Changes </button>
    </div>
</div>'
